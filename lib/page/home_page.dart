...
import 'package:valdez/data/category_model.dart';
import 'package:valdez/data/plant_data.dart';
import 'package:valdez/page/details_page.dart';
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0x1a1a71a4), width: 2),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 8,
              child: CircleAvatar(
                backgroundColor: Color(0xdd1a6b92),
                radius: 8,
                child: Image.asset(
                  'assets/icons/add.png',
                  color: white,
